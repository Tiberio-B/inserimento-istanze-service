...
public class RicercaSoggettoGiuridicoMapper extends RicercaSoggettoMapper<Soggetto, RicercaSoggettoGiuridicoDto> {

    @Override
    public Soggetto mapDtoToEntityImpl(RicercaSoggettoGiuridicoDto dto) throws RuntimeException {
        return null;
    }
