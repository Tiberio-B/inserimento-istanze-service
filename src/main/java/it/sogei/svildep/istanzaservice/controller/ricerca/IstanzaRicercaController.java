...
@Component
@NoArgsConstructor
public abstract class IstanzaRicercaController<D extends IstanzaRicercaDto> {
    ...
    public abstract IstanzaRicercaService<D> getService();

    public abstract IstanzaRicercaValidator<D> getValidator();
